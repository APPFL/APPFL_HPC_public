...
argparser.add_argument(
    "--server_config",
    type=str,
    default="./resources/config_gc/llm_chem/server_fedavg_ds.yaml",
)
argparser.add_argument(
    "--client_config", type=str, default="./resources/config_gc/llm_chem/clients_fedavg_ds.yaml"
)
...
server_agent.set_sample_size("76aadeb8-2852-452e-ae73-a9408f3cfbd9", 240) 
# server_agent.set_sample_size("fedab150-fb9f-43c9-9ea9-038b17be1348", 320)
# server_agent.set_sample_size("7af621d6-d761-450c-b955-0c9fed189cd8", 640) 
# server_agent.set_sample_size("b303b57e-d3c2-4e5f-9ea0-df9ce2a12654", 960) 
